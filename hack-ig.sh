...
#author AdelwinNL
  ...
  toilet -f mono12 -F border igmbf | lolcat

  echo 'author : AdelwinNL' | lolcat
echo 'Team   : FRI3NDS' | lolcat
echo 'blog   : adelwinft.blogspot.com' | lolcat
echo 'github : https://github.com/AdelwinNL' | lolcat
